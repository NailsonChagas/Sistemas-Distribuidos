...
public class UDPClient implements Runnable {
    ...
    public void run() {
        ...
        try {
            ...
            System.out.println("  - 'data'      : Obtem a data atual");
            System.out.println("  - 'hora'      : Obtem a hora atual");
            System.out.println("  - 'data_hora' : Obtem data e hora atual");
            System.out.println("  - 'sair'      : Encerra o cliente\n");

            while (true) {
                // Passo 2: ler entrada do usuario
                System.out.print("Digite o comando (data/hora/data_hora/sair): ");
